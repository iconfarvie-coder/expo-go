 ...
 */
export declare function Host({ children, style, matchContents: _matchContents, colorScheme: _colorScheme, layoutDirection: _layoutDirection, ...rest }: UniversalHostProps): import("react/jsx-runtime").JSX.Element;
